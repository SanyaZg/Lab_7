...
public class Athlete {
    ...
    public void getDataTheAthlete(){
        System.out.print("Спортсмен под номером "+getAthleteRegistrationNumber());
        System.out.print(" "+getNameOfTheAthlete());
        System.out.print(",представляющий страну "+getNameOfTheCountry());
        System.out.print(" в виде спорта "+getSport());
        System.out.print(" занял "+getPlace()+" место.");
    }
